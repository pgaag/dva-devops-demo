...
public class DevOpsControllerVersionTwo : ControllerBase
{
    ...
    private readonly ILogger<DevOpsControllerVersionTwo>? _logger;

    public DevOpsControllerVersionTwo(ILogger<DevOpsControllerVersionTwo>? logger, bool useLocalDatabase = true)
    {
